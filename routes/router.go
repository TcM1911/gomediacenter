...
func NewAPIRouter(
	userManager gomediacenter.UserManager,
	itemFinder gomediacenter.ItemFinder,
	sessionManager gomediacenter.SessionManager) *(mux.Router) {
	...
	// /Users
	newUsersRouter(userManager, itemFinder, sessionManager, router)
